...
|---|---|---|---|
| [patch-cc](https://github.com/anfreire/patch-cc) | patch the claude code binary — the settings menu that ships as a patcher | v0.1.3 | 2026-07-22 |
| [wiki-spaces](https://github.com/anfreire/wiki-spaces) | a wiki for ai agents — the whole spec is one heading | v4.2.0 | 2026-07-17 |
